...
function ServiceBooking() {
  ...
  return (
    <div>
      <div className="container servicebookingpage">
        ...
        <div className="last-booking-container">
        <div class="category-header-servicebooking">
            <span>Your Last Booking</span>
          </div>
          <div className="row">
                ...
                <div className="slide-details">
                  <div className="title">
                    ...
                    <div className="view-btn">
                      <button className="popular-view-btn">
                        View details
                      </button>
                    </div>
                  </div>
            ...
            <div className="col-6 mb-3">
              <div className="tab-img">
                ...
                <button className="add-btn reschedule-btn">Reschedule</button>
              </div>
            </div>
          </div>
        </div>
